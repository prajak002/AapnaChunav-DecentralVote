      ...
      <div className="home mt-4">
        ...
        <div className="homeLeft">
          ...
          <div className="flex items-center">
            <button
              onClick={loadWeb3}
              className="flex items-center bg-[#1B7FAA] text-[#fff] py-2 px-4 rounded-lg mr-6 hover:bg-[#21779c] text-3xl hover:shadow-[0_0_0_1px_rgba(0,0,0,0.3)]"
            >
              Connect to Metamask
              <img
                className="h-16 w-20"
            ...
            <button
              className="flex items-center bg-[#1B7FAA] text-[#fff] py-2 px-4 rounded-lg h-20 hover:bg-[#21779c] text-3xl hover:shadow-[0_0_0_1px_rgba(0,0,0,0.3)]"
              onClick={() => {
                document
