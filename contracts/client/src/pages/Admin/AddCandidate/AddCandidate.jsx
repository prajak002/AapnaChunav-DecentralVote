...
<hr className="w-1/2 text-[#ffc107]"/><span className="">❌</span><hr className="w-1/2 text-[#ffc107]"/>
              ...
              <div className="container-item">
                ...
                <div className="mb-2">
                  ...
                  <input
                    ...
                    className="border-b-2 py-2 items-center text-3xl my-4 border-[#878585] outline-none w-full text-[#ffc107]"
                  />
                </div>
                <div className="mb-2">
   ...
   <input
     ...
     className="border-b-2 items-center py-2 text-3xl m-b-4 border-[#878585] outline-none w-full text-[#ffc107]"
   />
 </div>
                  <div
                  ...
                  >
                    ...
                    <button
                      className="px-4 py-2 w-[120px] text-lg text-[#ffffff] border-2 bg-[#1B7FAA] rounded-lg font-bold hover:text-[#fff] hover:bg-[#3d73b2]"
                      disabled={
                        fileImg === null ||
                        imageUploaded === true ||
                        imageLoading === true
