      ...
      isElStarted && !isElEnded ? (
        <>
          {currentVoter.isRegistered ? (
            ...
            <div className="container-item attention">
              <center className="mx-auto mt-4">
                <p className="bg-[#f6b4b4] mx-auto text-center p-2 rounded">You're not registered. Please register first.</p>
                <br />
                <Link
                  to="/Registration"
                  className="underline mx-auto hover:text-[#598389]"
                >
                  Registration Page
                </Link>
              </center>
        ...
        isElEnded && (
            <div className="mx-auto text-center mb-10">
              ...
              <Link
                to="/Result"
                className="rounded bg-[#23598f] text-[#fff] py-2 px-4 font-bold hover:bg-[#226ab2]"
              >
                See results
              </Link>
            </div>
